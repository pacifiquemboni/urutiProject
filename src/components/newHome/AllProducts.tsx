...
const AllProducts = () => {
  ...
  return (
    <>
      ...
      <div className="lg:my-5 flex flex-row justify-evenly  flex-wrap h-128 lg:h-auto overflow-scroll lg:overflow-hidden">
        {list.length > 0 ? (
          list.map((item, index) => (
            <div
              key={index}
                ...
                <div className="flex flex-row items-center gap-4 text-black">
                  ...
                  <div className="w-full absolute bottom-0 left-0 border p-1 rounded bg-[#222e38]/70">
                    ...
                    {!user ? (
                      ...
                      // >
                      //   <button className="bg-[#FF9671] px-2 rounded text-white absolute bottom-1 right-2">
                      //     Play
                      //   </button>
                      // </Link>
                      <button
                      ...
                      //   <button className="bg-[#FF9671] px-2 rounded text-white absolute bottom-1 right-2">Play</button>
                      // </Link>
