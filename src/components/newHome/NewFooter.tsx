...
const NewFooter = () => {
  return (
    <div className="bg-[#19232c] h-60  lg:h-auto ">
      <div className="flex flex-row justify-between p-3 mx-2 lg:mx-20">
        <div>
          <img src={logo} alt="Casino Logo" width={70} />
        </div>
        <div className="flex flex-col lg:flex-row gap-5 lg:w-fit text-white">
