...
import { Client_Login } from "@/helpers/routes";
...
const ClientSignup = () => {
  ...
  return (
    <>
      ...
      <div className="bg-orange-bg-gradient lg:h-screen flex items-center justify-center">
        <div className="lg:mx-20 py-0 md:py-5">
          <div className="w-screen lg:w-96 h-128 lg:h-fit bg-white flex flex-col items-center lg:justify-around justify-center rounded-lg py-5">
            ...
            <p className="font-bold text-sm p-2">
              ...
              <span className="text-green-500 font-semibold">
                <Link to={Client_Login}>Login</Link>
              </span>
            </p>
