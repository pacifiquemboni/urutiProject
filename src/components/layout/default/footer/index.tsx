...
const FooterSection = () => {
  ...
  return (
    <footer id="down" className={`content-grid bg-[black] text-white`}>
      <div className="flex gap-3 [&>*]:flex-1 py-10 max-md:flex-col max-md:mx-auto">
        <div>
          <p className="mb-2">{t("Please contact us via email")}</p>
          <p>help@vunadeile.co.tz</p>
        </div>
        <div className="flex items-center gap-4">
          ...
          <p>
            <span className="block mb-2">Facebook</span>
            @VunaDeile
          </p>
        </div>
        <div className="flex">
          ...
          >
            ...
            <p>
              <span className="block mb-1">Instagram</span>
              @vunadeile
            </p>
          </Link>
        </div>
        <div className="flex items-center gap-4 max-w-fit">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <circle cx="16" cy="16" r="16" fill="url(#paint0_linear_22_144)" />
            <path
          ...
          <p>
            <span className="block mb-2">{t("contacts")}</span>
            0659 077 600
          </p>
        </div>
      </div>
      <div className="full-width bg-gradient-to-r from-primary from-10% to-[150%] to-secondary h-[1px]" />
      <div className="flex justify-between flex-wrap gap-4 py-4 text-grey">
        <p>
          {t("Powered by")}
          <Link to="https://urutihub.com" target="__blank__" className="font-semibold">
            Uruti Hub
          </Link>
        </p>
        <p>{t("Copyright")} © 2024 | vunadeile</p>
      </div>
    </footer>
  );
};
